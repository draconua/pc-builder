// api/ai-autobuild.js — Vercel Serverless Function for AI Smart Auto-Build
const { generateAiAutoBuild, getApiKey } = require('../tools/gemini_engine.js');
...
module.exports = async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    try {
      ...
      const result = await generateAiAutoBuild(body || {});
      ...
      console.error('[Vercel api/ai-autobuild] Error:', err);
