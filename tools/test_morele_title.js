...
(async () => {
  ...
  await page.goto('https://www.morele.net/wyszukiwarka/?q=Ryzen+7+7800X3D', { timeout: 20000, waitUntil: 'domcontentloaded' });
  ...
  console.log('Morele parsed items:', JSON.stringify(items, null, 2));
