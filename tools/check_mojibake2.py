...
print("Non-standard / corrupted characters in index.html:", len(corrupted), list(set(corrupted))[:10] if corrupted else "NONE")

# Check lines with question marks like ?
mojibake_lines = []
...
print(f"Lines with question mark: {len(mojibake_lines)}")
