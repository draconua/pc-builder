...
export function buildFromCurated(budgetPLN, partsDb, options = {}) {
  ...
  const localizedTier = {
    ...matchedTier,
    title: (matchedTier.titleKey && t(matchedTier.titleKey) !== matchedTier.titleKey) ? t(matchedTier.titleKey) : matchedTier.title,
    description: (matchedTier.descKey && t(matchedTier.descKey) !== matchedTier.descKey) ? t(matchedTier.descKey) : matchedTier.description
  };
