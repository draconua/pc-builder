...
const HARD_FALLBACKS = {
  ...
  'schematic.cooler_aio': { ru: 'ПОМПА СЖО', en: 'AIO PUMP', pl: 'POMPA AIO', ua: 'ПОМПА СРО' },
  ...
  'schematic.slot_cpu': { ru: '+ СОКЕТ CPU', en: '+ CPU SOCKET', pl: '+ GNIAZDO CPU', ua: '+ СОКЕТ CPU' },
  'schematic.slot_mb': { ru: '+ СЛОТ ПЛАТЫ', en: '+ MOTHERBOARD', pl: '+ PŁYTA GŁÓWNA', ua: '+ СЛОТ ПЛАТИ' },
  'schematic.slot_cooler': { ru: '+ КУЛЕР CPU', en: '+ CPU COOLER', pl: '+ CHŁODZENIE CPU', ua: '+ КУЛЕР CPU' },
  'schematic.slot_ram': { ru: '+ DDR5 RAM', en: '+ DDR5 RAM', pl: '+ DDR5 RAM', ua: '+ DDR5 RAM' },
  'schematic.slot_gpu': { ru: '+ PCIe 5.0 (GPU)', en: '+ PCIe 5.0 (GPU)', pl: '+ PCIe 5.0 (GPU)', ua: '+ PCIe 5.0 (GPU)' },
  'schematic.slot_ssd': { ru: '+ M.2 NVMe', en: '+ M.2 NVMe', pl: '+ M.2 NVMe', ua: '+ M.2 NVMe' },
  'schematic.slot_hdd': { ru: '+ 3.5" HDD BAY', en: '+ 3.5" HDD BAY', pl: '+ KIESZEŃ HDD', ua: '+ ВІДСІК 3.5" HDD' },
  'schematic.slot_psu': { ru: '+ ОТСЕК БП', en: '+ PSU BAY', pl: '+ WNĘKA ZASILACZA', ua: '+ ВІДСІК БЖ' },
